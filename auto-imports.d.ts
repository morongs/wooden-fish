...
export {}
declare global {
  const Concat: typeof import('./src/components/Concat')['Concat']
  ...
  const Logo: typeof import('./src/components/Logo')['Logo']
  ...
  const USwitch: typeof import('./src/components/USwitch')['USwitch']
  const Volume: typeof import('./src/components/Volume')['Volume']
